...
const MovieCards:React.FC<any> = ({data, type}) => {
  ...
  return (
    <div onClick={() => movieClickHandler(clickHandlerArguements)} key={data?.id} className="lg:min-w-52 md:min-w-40 lg:w-52 md:w-40 min-w-32 w-32 cursor-pointer rounded-md overflow-hidden py-4">
