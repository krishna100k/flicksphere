          ...
          return (
            <div className={`relative min-w-full h-full overflow-y-hidden transition-all ease-in-out duration-1000`} style={{transform: `translateX(-${index * 100}%)`}}  >
              <div className=" w-full h-full z-[1] absolute flex">
                <div className="w-[40%] h-full  flex justify-end items-start mt-28 lg:mr-20">
                  <Image
                ...
                <div className="w-[60%] h-full gap-5 lg:gap-10 flex justify-start mt-28 items-start flex-col z-10">
                  <h1 className="font-black lg:text-xl z-[4]">
                    {movie?.original_title}
                  </h1>
                  <p className="w-[95%] lg:w-[50%] text-sm z-[4]">{movie?.overview}</p>
